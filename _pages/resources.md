...
These are resources I have found genuinely useful in my own learning journey in machine learning research. They range from textbooks to course notes — feel free to reach out if you have recommendations to add!
...
_Richard S. Sutton & Andrew G. Barto — 2nd ed._

This has probably become the standard textbook for reinforcement learning, covering the core ideas from multi-armed bandits and dynamic programming through temporal-difference learning, function approximation, and policy gradient methods. If you're aiming at quickly building the foundations, my personal suggestions is to read Chapter 3-6, 9, and 13.